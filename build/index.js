...
var localizations = exports.localizations = {
    en: ['M', 'T', 'W', 'R', 'F', 'S', 'U'],
    es: ['L', 'M', 'X', 'J', 'V', 'S', 'D']
};
...
var DayPicker = function (_Component) {
    ...
    _createClass(DayPicker, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.props.ln) {
                this.setState({
                    days: _localization.localizations[this.props.ln]
                });
            }
        }
    }, {
        key: 'selectedDay',
        value: function selectedDay(value) {
            var _this3 = this;

            this.setState({
                selected: [].concat(_toConsumableArray(this.state.selected), [value])
            }, function () {
                _this3.filterValue();
                _this3.markAsSelected(value);
            });
        }
    }, {
        key: 'markAsSelected',
        value: function markAsSelected(value) {
        ...
        value: function filterValue() {
            ...
            var result = this.state.selected.filter(function (v, _, a) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                this.state.days && this.state.days.map(function (d) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'day-check day-' + d, onClick: function onClick() {
                                return _this5.selectedDay(d);
                            } },
                        d
                    );
                })
...
// Module
exports.push([module.i, ".day-picker {\n    display: flex;\n    align-items: center;\n}\n\n.day-check {\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    font-family: \"Roboto\";\n    font-size: 10px;\n    font-weight: 500;\n    margin-right: .5rem;\n    width: 24px;\n    height: 24px;\n    background: #f1f3f4;\n    color: #80868b;\n    border-radius: 100%;\n    cursor: pointer;\n}\n\n.day-check.checked {\n    color: #fff;\n    background: #1a73e8;\n}", ""]);
